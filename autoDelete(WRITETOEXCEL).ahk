...
emptyStr =
currentMat =
epaError = EPA Registered Item must be Y or N
rxTypeError = RX Type should be Drug/Device with Pedigree type
rxValueError = Only allowed RX values: RR, RB, RC, RS.
InputBox, UserInput, Number of Materials, Please enter the number of materials to delete
matMax = %UserInput%
WinWait, Microsoft Excel - RX.xlsx, 
IfWinNotActive, Microsoft Excel - RX.xlsx, , WinActivate, Microsoft Excel - RX.xlsx, 
WinWaitActive, Microsoft Excel - RX.xlsx, 
Sleep, 200
...
{
Send, {SHIFTDOWN}{END}{SHIFTUP}{CTRLDOWN}s{CTRLUP}
if(clipboard == epaError)
{
WinWait, Microsoft Excel - RX.xlsx, 
IfWinNotActive, Microsoft Excel - RX.xlsx, , WinActivate, Microsoft Excel - RX.xlsx, 
WinWaitActive, Microsoft Excel - RX.xlsx, 
cellCount := matCount + 2
Send, {CTRLDOWN}g{CTRLUP}
Sleep, 100
Send, G%cellCount%{ENTER}
Sleep, 100
Send, > {CTRLDOWN}v{CTRLUP}
WinWait, ZQUAL editing screen, , 0.5
IfWinNotActive, ZQUAL editing screen, , WinActivate, ZQUAL editing screen, 
WinWaitActive, ZQUAL editing screen, , 0.5
MouseClick, left, 236, 746
Sleep, 100
Send, N
Sleep, 100
Send, {TAB}N
...
Send, {TAB}N
Sleep, 100
MouseClick, left, 244, 330
Sleep, 100
Send, {BACKSPACE}{CTRLDOWN}s{CTRLUP}
...
IfWinActive Information
{
WinWait, RX.txt - Notepad,
IfWinNotActive, RX.txt - Notepad, , WinActivate, RX.txt - Notepad, 
WinWaitActive, RX.txt - Notepad,
